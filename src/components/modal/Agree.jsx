      ...
      (error) => {
        ...
        switch (error.code) {
          case error.PERMISSION_DENIED:
            alert("위치 정보 권한을 허용해야 서비스 이용이 가능합니다.");
            break;
          case error.POSITION_UNAVAILABLE:
            alert("위치 정보를 사용할 수 없습니다.");
            break;
          case error.TIMEOUT:
            alert("위치 정보를 불러오는 데 시간이 초과되었습니다.");
            break;
          default:
...
<p className='agree-p1'>위치정보 접근 권한 안내</p>
          </div>
          <div className="agree-box2">
            <p className='agree-p2'>FriendPass는 사용자의 위치를 기반으로 <br />
매칭 장소를 추천하는 서비스입니다.</p>
