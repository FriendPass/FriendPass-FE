...
const Mypage = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      console.log("[프로필 응답 원본]", data);               // ✅ 전체 응답 확인
      console.log("[프로필 이미지 값]", data.profileImage); // ✅ 이미지 경로 확인
...
<path d="M21.8333 24.125V21.5417C21.8333 20.1714 21.289 18.8572 20.32 17.8883C19.3511 16.9193 18.0369 16.375 16.6667 16.375H6.33332C4.96304 16.375 3.64888 16.9193 2.67994 17.8883C1.711 18.8572 1.16666 20.1714 1.16666 21.5417V24.125M16.6667 6.04167C16.6667 8.89514 14.3535 11.2083 11.5 11.2083C8.64652 11.2083 6.33332 8.89514 6.33332 6.04167C6.33332 3.1882 8.64652 0.875 11.5 0.875C14.3535 0.875 16.6667 3.1882 16.6667 6.04167Z" stroke="#1E1E1E" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
<p>{t("menu.mypage")}</p>
        </div>
        </div>
